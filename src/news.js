...
const API_URL = `https://gnews.io/api/v3/search?q=tech&token=${process.env.REACT_APP_API_KEY}`;
const API_URL2= `https://gnews.io/api/v3/search?q=technology&token=${process.env.REACT_APP_API_KEY}`;
const API_URL3= `https://gnews.io/api/v3/search?q=AI&token=${process.env.REACT_APP_API_KEY}`
